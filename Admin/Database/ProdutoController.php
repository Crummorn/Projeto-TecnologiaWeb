...
function possivelLucroDeUmProduto($id) {
    return $GLOBALS['produtoService']->possivelLucroDeUmProdutoEspecifico($id);
}

function possivelLucroDeUmFornecedor($id) {
    return $GLOBALS['produtoService']->possivelLucroDeUmFornecedorEspecifico($id);
}

function totalEstoqueProdutosFornecedor($fornecedor_id) {
